              ...
              >
                ...
                {activeTab === cat.label && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 right-0 h-[3px] bg-[#FDB913] rounded-full"
                  />
                )}
              </button>
            ))}
            ...
            <div className="flex-1">
              {isLoading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  {[1, 2, 3].map(n => (
                    <div key={n} className="aspect-[4/5] bg-gray-50 animate-pulse rounded-3xl" />
                  ))}
                </div>
              ) : products.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                ...
                <div className="h-full flex flex-col items-center justify-center py-20 rounded-3xl bg-gray-50 border-2 border-dashed border-gray-100">
                  <p className="text-gray-400 font-outfit font-black uppercase tracking-widest">
                    Coming Soon
                  </p>
                </div>
              )}
