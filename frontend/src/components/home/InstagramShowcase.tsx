...
const INSTA_CARDS: InstagramCardData[] = [
  {
    ...
    href: 'https://www.instagram.com/p/Dc2xRsrjKxT/?img_index=1',
  ...
  },
  {
    ...
    followers: '13.1K',
    following: '4',
    img: '/junior/Drift Sky Blue_ Hero 1.png',
    fallback: '/junior/junior hero.png',
    href: 'https://www.instagram.com/p/DbLf5MnDKPL/?img_index=1',
  ...
  },
  {
    ...
    followers: '13.1K',
    following: '4',
    img: '/Category/Travelling Bag.jpg',
    fallback: '/Creatives/2.png',
    href: 'https://www.instagram.com/p/DcgZ4RKs6sF/',
    caption: 'Engineered for smooth motion & durability on every road.',
  },
  {
    handle: 'priority.bags',
    avatar: '/priority-icon.png',
    ...
    caption: 'Fresh Fits. Real Vibes. Ready for college, work & getaways.',
  },
  {
    handle: 'priority.bags',
    avatar: '/priority-icon.png',
    ...
    caption: 'Where every stitch carries a piece of your journey & our heart.',
  },
];
