...
export const HeroSlider = () => {
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-[#0F1417]"
      style={{ aspectRatio: slide.aspectRatio }}
    >
      {/* Only the active slide is mounted. Keeping an outgoing image while the
          aspect ratio changes briefly produced visible gutters between banners. */}
      <motion.div
        key={current}
